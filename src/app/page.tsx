    ...
    >
        ...
        {showModal && (
          ...
          >
            ...
            >
              ...
              <p className="mb-6 text-gray-700">{t.music.question}</p>
          ...
          >
            ...
            >
              ...
              <div className="bg-rose-50 p-8 rounded-2xl shadow-lg border border-rose-200 text-gray-800 text-lg leading-relaxed">
                <p>{t.message.contentTop}</p>
                <p>{t.message.contentMiddle}</p>
                <p className="font-semibold text-rose-700 italic text-xl  bg-rose-50">
                  {t.message.closing}
                </p>
              </div>
            </motion.div>
      ...
      <section className="py-12 px-4 bg-rose-50">
        ...
        >
          ...
          <CountdownTimer targetDate="2025-09-24T18:00:00" t={t} />
        </motion.div>
      </section>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="absolute bottom-0 left-0 p-4 text-white">
                  ...
                  <p className="text-sm text-gray-200">
                    {t.details.banketHall.street}
                  </p>
                  <p className="text-sm text-gray-200">
                    {t.details.banketHall.city}
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-12 px-4 bg-rose-700 text-white text-center">
        ...
        >
          ...
          <p className="text-lg text-rose-100">{t.invitation.names}</p>
